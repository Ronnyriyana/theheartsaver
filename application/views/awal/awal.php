...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body id="page">
        ...
        <div class="container">
            ...
            <header>
                <h1>The <span>Heart Saver</span></h1>
                <img src="<?php echo base_url(); ?>assets/images/Denyutnadi.png" class="gambar">
                <h2>Monitoring your family</h2>
            </header>
			<p class="codrops-demos">
					<a href="<?php echo base_url('index.php/monitoring'); ?>">Monitoring</a>
					<a href="<?php echo base_url('index.php/log_aktivitas'); ?>">Log Aktivitas</a>
				</p>
        </div>
    </body>
</html>