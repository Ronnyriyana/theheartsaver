...
<head>
    <title><?php echo isset ($title_page)?$title_page." | ":'' ?>The Heart Saver</title>
    <!-- Meta tag Keywords -->
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/slider.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
