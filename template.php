...
<head>
    <title>Medizin Medical Category Bootstrap Responsive Web Template | Home :: W3layouts</title>
    <!-- Meta tag Keywords -->
...
<body>
                        ...
                        <div class="header-section">
                            <h1>
                                <a class="navbar-brand logo editContent" href="index.html">
                                    <span class="fa fa-heartbeat"></span>Saver
                                </a>
                            </h1>
                        </div>
        ...
        <div class="cpy-right py-3">
            <div class="container">
                <div class="row">
                    <p class="col-md-10 text-left">© 2019 Medizin. All rights reserved | Design by
